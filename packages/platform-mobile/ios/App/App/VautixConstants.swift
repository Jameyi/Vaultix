...
enum VautixVault {
	...
	static let appGroup = "group.app.vautix.mobile"
	// Shared Keychain access group, shared by the app and the AutoFill extension. This MUST equal
	// the resolved keychain-access-groups entitlement ($(AppIdentifierPrefix)app.vautix.mobile.shared)
