...
// Vautix's passkey provider for the Android Credential Manager (API 34+). The system pulls
...
// Vautix" entry whose PendingIntent mints + persists. The heavy work (unlock, native crypto)
// runs in those Activities, not here - mirroring VautixAutofillService. Passwords stay on the
...
class VautixCredentialService : CredentialProviderService() {
    ...
    override fun onBeginCreateCredentialRequest(
        ...
        // Offer "Save passkey in Vautix"; the PendingIntent unlocks, mints, and persists.
        val intent = Intent(this, CredentialFulfillActivity::class.java)
