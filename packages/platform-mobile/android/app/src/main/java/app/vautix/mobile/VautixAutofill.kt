...
// The Android peer of iOS VautixConstants.swift. The biometric alias + prefs MUST match
...
object VautixAutofill {
    ...
    const val BIOMETRIC_KEY_ALIAS = "vautix.biometric.vek"
    ...
    const val SESSION_KEY_ALIAS = "vautix.autofill.session"
    ...
    const val LOG_TAG = "VautixAutofill"
}
